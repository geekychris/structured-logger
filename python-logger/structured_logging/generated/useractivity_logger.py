...
class UserActivityLogger(BaseStructuredLogger):
    ...
    @classmethod
    def builder(cls) -> "UserActivityLoggerBuilder":
        """Create a builder for constructing log records."""
        return UserActivityLoggerBuilder()


class UserActivityLoggerBuilder:
    """Builder for UserActivity log records."""
    ...
    def user_id(self, value: str) -> "UserActivityLoggerBuilder":
        """Set user_id."""
        self._user_id = value
        return self
    def username(self, value: str) -> "UserActivityLoggerBuilder":
        """Set username."""
        self._username = value
        return self
    def event_type(self, value: str) -> "UserActivityLoggerBuilder":
        """Set event_type."""
        self._event_type = value
        return self
    def event_date(self, value: date) -> "UserActivityLoggerBuilder":
        """Set event_date."""
        self._event_date = value
        return self
    def timestamp(self, value: datetime) -> "UserActivityLoggerBuilder":
        """Set timestamp."""
        self._timestamp = value
        return self
    def ip_address(self, value: str) -> "UserActivityLoggerBuilder":
        """Set ip_address."""
        self._ip_address = value
        return self
    def user_agent(self, value: str) -> "UserActivityLoggerBuilder":
        """Set user_agent."""
        self._user_agent = value
        return self
    def endpoint(self, value: str) -> "UserActivityLoggerBuilder":
        """Set endpoint."""
        self._endpoint = value
        return self
    def http_method(self, value: str) -> "UserActivityLoggerBuilder":
        """Set http_method."""
        self._http_method = value
        return self
    def status_code(self, value: int) -> "UserActivityLoggerBuilder":
        """Set status_code."""
        self._status_code = value
        return self
    def response_time_ms(self, value: int) -> "UserActivityLoggerBuilder":
        """Set response_time_ms."""
        self._response_time_ms = value
        return self
    def session_id(self, value: str) -> "UserActivityLoggerBuilder":
        """Set session_id."""
        self._session_id = value
        return self
    def metadata(self, value: Dict[str, str]) -> "UserActivityLoggerBuilder":
        """Set metadata."""
